...
# Clone the git repository into your Desktop...
msg="Cloning cobarClient and cobarAPI into ../"
h2
cd ../
git clone git@github.com:cflynn07/cobarClient.git
git clone ssh://git@bitbucket.org/cflynn_us/cobarapi.git
